...
import Soutien_Psycho from "./components/soutien/SoutienPsycho";
import Humeur from "./components/soutien/humeur/Humeur";
import Humeur_Qsts from "./components/soutien/humeur/HumeurQsts";
import Humeur_Answers from "./components/soutien/humeur/HumeurAnswers";
import Humeur_Result from "./components/soutien/humeur/HumeurResult";
    ...
    <>
      <BrowserRouter basename="/react/template">
        <Routes>
          ...
          <Route path="/soutien-psycho" element={<Soutien_Psycho />} />
          <Route path="/humeur" element={<Humeur />} />
          <Route path="/humeur-qsts" element={<Humeur_Qsts />} />
          <Route path="/humeur-answers" element={<Humeur_Answers />} />
          <Route path="/humeur-result" element={<Humeur_Result />} />
